...
export default {
  mode: "studio",
  description:
    "Undercurrents: eighteen years of Tame Impala setlists, venues and tours, read through predictive models that always show their score against the simplest baseline that could beat them.",
  ...
  // Dark only, because the app is dark only: `body` is #0d0710 with white text and there
  // is no light variant anywhere in src/. Offering a light theme on the canvas would
  // promise a surface the product does not have.
  themes: ["dark"],
  port: 5199,
